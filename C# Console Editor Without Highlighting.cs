...
namespace Console_Editor
{
    class editor
    {
                ...
                for (int i = 0; i <= Screen_Height - 2; i++) {
                    ...
                    if (Buffer_Height + i < Text.Length)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                Console.Write(Text[Buffer_Height + i].Substring(0, Screen_Width - 2));
                            }
                            else
                            {
                                Console.Write(Text[Buffer_Height + i].PadRight(Screen_Width,' '));
                            }
                            Console.WriteLine("");
                        }
                    }
        ...
        void WriteText(string Content, int Screen_Width, int Screen_Height, int Buffer_Width, int Buffer_Height)
        {
            ...
            {
                Console.Write(Content.PadRight(Screen_Width, ' '));
            }
            else
            {
                if (Content.Substring(Buffer_Width).Length > Screen_Width)
                {
                    Console.Write(Content.Substring(Buffer_Width, Screen_Width - 1));
                ...
                {
                    Console.Write(Content.Substring(Buffer_Width));
                }
            }
        }
...
public class HistoryEntry
{
    ...
    public int Buffer_Width { get; set; }
    public int Buffer_Height { get; set; }

    public int Cursor_Char { get; set; }
